...
: ${AMENT_CURRENT_PREFIX:="/opt/moveit_studio/user_ws/install/ur_hardware_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_hardware_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_hardware_config/environment/path.sh"
