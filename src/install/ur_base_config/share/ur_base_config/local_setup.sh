...
: ${AMENT_CURRENT_PREFIX:="/opt/moveit_studio/user_ws/install/ur_base_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_base_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ur_base_config/environment/path.sh"
