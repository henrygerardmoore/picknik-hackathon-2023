...
#include "apriltag_ros_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const apriltag_ros_msgs::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  apriltag_ros_msgs::msg::Detection & ros_message)
{
  // Member: family
  cdr >> ros_message.family;
...
{
  auto typed_message =
    static_cast<const apriltag_ros_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<apriltag_ros_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  return &apriltag_ros_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apriltag_ros_msgs, msg, Detection)() {
  return &apriltag_ros_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
