...
: ${AMENT_CURRENT_PREFIX:="/opt/moveit_studio/user_ws/install/starter_files"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/starter_files/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/starter_files/environment/path.sh"
